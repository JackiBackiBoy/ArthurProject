...
float FindAxisLeastPenetration(unsigned int* faceIndex, PolygonShape* A, PolygonShape* B)
{
...
void FindIncidentFace(Vec2* v, PolygonShape* RefPoly, PolygonShape* IncPoly, unsigned int referenceIndex)
{
